...
public class UserConnectionModelImpl extends ConexaoModelImpl implements UserConnectionModel {
    ...
    public UserConnectionModelImpl(Connection conexao) {
        try {
    ...
    public static List<UsuarioController> listarUsuarios() {
        ...
        try {
            ...
            ResultSet resultSet = preparedStatement.executeQuery();
            while (resultSet.next()) {
                usuarios.add(new UsuarioController(
